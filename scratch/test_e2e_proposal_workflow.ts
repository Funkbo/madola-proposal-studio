...
import { convertExtractionToInteractiveProposal } from "../src/lib/repositories/interactiveProposalRepository";
...
async function testE2EWorkflow() {
  ...
  console.log(
    "System Specs:",
    interactiveProp.system.systemSizeKwp,
    "kWp |",
    interactiveProp.system.panelCount,
    "panels |",
    interactiveProp.system.batteryCapacityKwh,
    "kWh usable battery"
  );
